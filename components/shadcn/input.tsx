  ...
  return (
    <input
      ...
      className={cn(
        ...
        "bg-white text-neutral-900 dark:text-violet-950 border-neutral-200 placeholder:text-neutral-400/80 h-13 w-full min-w-0 rounded-md border px-3 py-1 text-base shadow-xs transition-all outline-none md:text-lg",
